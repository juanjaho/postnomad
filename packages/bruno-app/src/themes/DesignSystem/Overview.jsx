  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1 }}>
        ...
        <div style={{ fontSize: '13px', opacity: 0.8, marginBottom: '4px' }}>{description}</div>
        {example && (
          <div
            style={{
              fontSize: '12px',
  ...
  return (
    ...
    >
      ...
      <div style={{ marginBottom: '64px' }}>
        ...
        >
          A unified visual language for building consistent, accessible, and beautiful interfaces across Bruno's
          ecosystem.
        </p>
...
export const PrimaryColorsRender = () => {
  ...
  return (
    ...
    >
      {/* Hero */}
      <div style={{ marginBottom: '48px' }}>
        <h1 style={{ fontSize: '32px', fontWeight: 700, marginBottom: '12px' }}>Primary Colors</h1>
        <p
          style={{
            fontSize: '16px',
            opacity: 0.7,
      ...
      <Section title="In Context">
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '24px', flexWrap: 'wrap' }}>
            ...
            <span style={{ color: palette.primary.TEXT, fontSize: '14px' }}>View documentation →</span>
...
export const BackgroundLayersRender = () => {
  ...
  return (
    ...
    >
      {/* Hero */}
      <div style={{ marginBottom: '48px' }}>
        <h1 style={{ fontSize: '32px', fontWeight: 700, marginBottom: '12px' }}>Background Layers</h1>
        <p
          style={{
            fontSize: '16px',
            opacity: 0.7,
        ...
        >
          A layered background system inspired by geological strata. Each layer serves a distinct purpose in creating
          visual hierarchy.
        </p>
      </div>
              ...
              <div style={{ display: 'flex', gap: '6px' }}>
                <div
                  style={{
                    ...
                    height: '10px',
                    borderRadius: '50%',
                    backgroundColor: theme.colors?.text?.danger || '#ff5f57'
                  }}
                />
                <div
                  style={{
                    ...
                    height: '10px',
                    borderRadius: '50%',
                    backgroundColor: theme.colors?.text?.warning || '#ffbd2e'
                  }}
                />
                <div
                  style={{
                    ...
                    height: '10px',
                    borderRadius: '50%',
                    backgroundColor: theme.colors?.text?.green || '#28c840'
                  }}
                />
              </div>
      ...
      <Section title="Surface Variants">
        ...
        >
          {[
            {
              name: 'surface0',
              token: 'background.surface0',
              color: theme.background.surface0,
              purpose: 'Cards & Inputs',
              desc: 'Slightly elevated from base, used for cards, input fields, and contained elements.'
            },
            {
              name: 'surface1',
              token: 'background.surface1',
              color: theme.background.surface1,
              purpose: 'Hover States',
              desc: 'One step brighter, indicates hover or light interaction feedback.'
            },
            {
              name: 'surface2',
              token: 'background.surface2',
              color: theme.background.surface2,
              purpose: 'Active States',
              desc: 'Highest elevation surface, used for active selections and pressed states.'
            }
...
export const TextColorsRender = () => {
  ...
  const hierarchyLevels = [
    ...
    {
      name: 'Subtext0',
      color: theme.colors.text.subtext0,
      desc: 'Timestamps, hints, placeholders, and disabled states'
    }
  ];
  ...
  const semanticColors = [
    {
      ...
      desc: 'Positive states and confirmations',
      example: 'GET method, success messages'
    },
    {
      name: 'Danger',
      color: theme.colors.text.danger,
      desc: 'Errors and destructive actions',
      example: 'DELETE method, error messages'
    },
    {
      name: 'Warning',
      color: theme.colors.text.warning,
      desc: 'Caution states and notices',
      example: 'PUT/PATCH methods, deprecation notices'
    },
    {
      name: 'Accent',
      color: theme.colors.text.purple,
      desc: 'Special content markers',
      example: 'GraphQL indicators, unique tags'
    },
    {
      name: 'Link',
      color: theme.textLink,
      desc: 'Interactive text and navigation',
      example: 'Hyperlinks, clickable references'
    }
  ];
  ...
  return (
    ...
    >
      {/* Hero */}
      <div style={{ marginBottom: '48px' }}>
        <h1 style={{ fontSize: '32px', fontWeight: 700, marginBottom: '12px' }}>Text Colors</h1>
        <p
          style={{
            fontSize: '16px',
            opacity: 0.7,
        ...
        >
          Text colors create visual hierarchy and convey meaning. Use progressively muted colors for less important
          information.
        </p>
      </div>
...
export const BordersAndOverlaysRender = () => {
  ...
  const overlays = [
    ...
    {
      name: 'Overlay1',
      color: theme.overlay.overlay1,
      purpose: 'Medium',
      desc: 'Standard overlays, dropdown backdrops'
    },
  ...
  return (
    ...
    >
      {/* Hero */}
      <div style={{ marginBottom: '48px' }}>
        <h1 style={{ fontSize: '32px', fontWeight: 700, marginBottom: '12px' }}>Borders & Overlays</h1>
        <p
          style={{
            fontSize: '16px',
            opacity: 0.7,

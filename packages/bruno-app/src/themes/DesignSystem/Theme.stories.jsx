    ...
    return (
      <div style={{ padding: '24px', backgroundColor: theme.bg, minHeight: '100vh' }}>
        <div style={{ marginBottom: '32px' }}>
          <h1 style={{ fontSize: '32px', fontWeight: 700, marginBottom: '12px', color: theme.text }}>Palette</h1>
          <p
            style={{
              fontSize: '16px',
              opacity: 0.7,
          ...
          >
            The foundational color tokens that make up the {isDark ? 'dark' : 'light'} theme. All semantic colors are
            derived from these base values.
          </p>
        </div>
    ...
    return (
      <div style={{ padding: '24px', backgroundColor: theme.bg, minHeight: '100vh' }}>
        <div style={{ marginBottom: '32px' }}>
          ...
          >
            Semantic color mappings derived from the base palette. Intent colors convey meaning, while syntax colors
...
export const HueWheel = {
  render: () => {
    ...
    return (
      <div style={{ padding: '24px', backgroundColor: theme.bg, minHeight: '100vh' }}>
        <div style={{ marginBottom: '32px' }}>
          <h1 style={{ fontSize: '32px', fontWeight: 700, marginBottom: '12px', color: theme.text }}>Hue Wheel</h1>
          <p
            style={{
              fontSize: '16px',
              opacity: 0.7,
          ...
          >
            Distribution of the 14 hue colors across the color wheel (0° to 360°). Provides full spectrum coverage for
            diverse UI needs.
          </p>
        </div>
          ...
          {sorted.map(([name, color]) => {
            ...
            return (
              <div key={name} style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                ...
                <div
                  style={{ width: '40px', fontSize: '11px', opacity: 0.5, fontFamily: 'monospace', color: theme.text }}
                >
                  {hue}°
                </div>
...
export const HueAnalysis = {
  render: () => {
    ...
    return (
      <div style={{ padding: '24px', backgroundColor: theme.bg, minHeight: '100vh' }}>
        <div style={{ marginBottom: '32px' }}>
          <h1 style={{ fontSize: '32px', fontWeight: 700, marginBottom: '12px', color: theme.text }}>Hue Analysis</h1>
          <p
            style={{
              fontSize: '16px',
              opacity: 0.7,
          ...
          >
            Statistical analysis of saturation and lightness consistency across the 14 hue colors. Lower standard
            deviation indicates more uniform values.
          </p>
        </div>

        <StatCard title="Saturation Distribution" stats={satStats} values={saturations} hueData={hues} />

        <StatCard title="Lightness Distribution" stats={lightStats} values={lightnesses} hueData={hues} />

  ...
  reducers: {
    ...
    responseReceived: (state, action) => {
      ...
      if (collection) {
        ...
        if (item) {
          ...
          const timestamp =
            timelineRequest?.timestamp instanceof Date
    ...
    setQueryParams: (state, action) => {
      ...
      const newQueryParams = map(
        params,
        ({ uid, name = '', value = '', description = '', annotations = null, type = 'query', enabled = true }) => ({
          uid: uid || uuid(),
          name,
          value,
          description,
    ...
    removeSaveTransientRequestModal: (state, action) => {
      ...
      state.saveTransientRequestModals = state.saveTransientRequestModals.filter((modal) => modal.item.uid !== itemUid);
    },

...
import { IconChevronDown, IconChevronRight, IconCircleCheck, IconCircleX } from '@tabler/icons';
...
const TestSection = ({ title, results, isExpanded, onToggle, type = 'test' }) => {
    ...
    <div className="mb-4">
      ...
      >
        <span className="dropdown-icon mr-2 flex items-center">
          {isExpanded ? <IconChevronDown size={18} stroke={1.5} /> : <IconChevronRight size={18} stroke={1.5} />}
        </span>

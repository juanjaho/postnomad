      ...
      <div className="flex flex-col h-full relative px-4 py-4">
        <div className="flex flex-wrap items-center tabs" role="tablist">
          <div
            ...
            role="tab"
            data-testid="folder-settings-tab-headers"
          ...
          <div
            ...
            role="tab"
            data-testid="folder-settings-tab-script"
          ...
          <div
            className={getTabClassname('test')}
            role="tab"
            data-testid="folder-settings-tab-test"
            onClick={() => setTab('test')}
          >
            Test
            {hasTests && <StatusDot />}
          ...
          <div
            ...
            role="tab"
            data-testid="folder-settings-tab-vars"
            onClick={() => setTab('vars')}
          >
            Vars
          ...
          <div
            ...
            role="tab"
            data-testid="folder-settings-tab-auth"
            onClick={() => setTab('auth')}
          >
            Auth
            {hasAuth && <StatusDot />}
          ...
          <div
            className={getTabClassname('docs')}
            role="tab"
            data-testid="folder-settings-tab-docs"
            onClick={() => setTab('docs')}
          >
            Docs
          </div>
